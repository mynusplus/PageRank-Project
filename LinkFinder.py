...
#Uses Beatiful Soup 4 to look through the pages and find what values their elements with href have, aka what pages they
#have outgoing links to. Stores in links dictionary.
links = {}
